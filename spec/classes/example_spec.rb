    ...
    on_supported_os.each do |os, facts|
      context "on #{os}" do
        ...
        context "rspec_monitor class without any parameters" do
          ...
          it { is_expected.to contain_package('rspec-nagios-formatter').with_provider('puppet_gem') }
          it { is_expected.to contain_package('serverspec').with_provider('puppet_gem') }
